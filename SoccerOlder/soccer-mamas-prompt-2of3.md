...
- **Clear all velocities, burst targets, cooldown timers, and `ball.checkedBy`** before resetting positions (same purge as halftime — prevents players carrying stale movement intent into the restart)
